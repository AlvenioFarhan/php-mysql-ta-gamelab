...
<head>
    ...
    <title>ShoesMarket: Temukan Sepatu yang Tepat untuk Gaya dan Kebutuhan Anda</title>
</head>
<body>

   
<!-- WELCOME -->
<div class="bg-secondary-subtle text-center py-1">
  <h2>Welcome, <?php echo $_SESSION['username']; ?>!</h2>
      ...
      >
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <a href="dashboardUser.php" type="button" class="btn btn-primary">Add to Cart</a>
              <button
                type="button"
                class="btn btn-danger"
                data-bs-dismiss="modal"
    ...
    >
      <div class="container-fluid">
        ...
        <form class="d-none d-lg-flex ms-auto" role="search">
          ...
          <a href="dashboardUser.php" class="d-flex justify-content-center">
            <img src="asset/icon/profil.png" alt="profil" class="w-25">
            </a>
          <!-- <button
            type="button"
    ...
    <div class="container w-25 mb-5">
      <a href="dashboardUser.php" type="button" class="btn btn-outline-dark">See More</a>
    </div>
      ...
      <div class="container">
        ...
        >
          ...
          >
            ...
            >
              <a href="dashboardUser.php" type="button" class="btn btn-danger w-50 w-md-25">
                GET PROMO
              </a>
            </div>
          </div>
