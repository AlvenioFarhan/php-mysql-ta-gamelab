      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <!-- Form -->
            <form action="proses-edit-user-admin.php" method="post">
            <input type="hidden" name="id" value="<?php echo $users['id'] ?>" />
              <div class="card-body">
                <div class="form-group">
                  <label for="inputName">Username</label>
                  <input type="text" id="inputName" class="form-control" name="username" value="<?php echo $users['username'] ?>">
                </div>
                <div class="form-group">
                  <label for="inputName">Email</label>
                  <input type="text" id="inputEmail" class="form-control" name="email" value="<?php echo $users['email'] ?>">
                </div>
                <div class="form-group">
                  <label for="inputName">Password</label>
                  <input type="text" id="inputPassword" class="form-control" name="password" value="Password Baru">
                  <p style="color: red;">*password wajib diganti baru</p>
                </div>
                
                <div class="row">
                  <div class="col-12 d-flex d-flex justify-content-around mb-2">
