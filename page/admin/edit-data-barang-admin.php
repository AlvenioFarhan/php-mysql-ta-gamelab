      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <!-- Form -->
            <form action="proses-edit-data-barang-admin.php" method="post" enctype="multipart/form-data">
              <input type="hidden" name="product_id" value="<?php echo $products['product_id'] ?>" />
              <div class="card-body">
                <div class="form-group">
                  <label for="inputName">Name</label>
                  <input type="text" id="inputName" class="form-control" name="name" value="<?php echo $products['name'] ?>">
                </div>
                <div class="form-group">
                  <label for="inputDescription">Description</label>
                  <input type="text" id="inputDescription" class="form-control" name="description" value="<?php echo $products['description'] ?>">
                </div>
                <div class="form-group">
                  <label for="inputPrice">Price</label>
                  <input type="text" id="inputPrice" class="form-control" name="price" value="<?php echo $products['price'] ?>">
                </div>
                <div class="form-group">
                  <label for="inputQuantity">Stock_Quantity</label>
                  <input type="text" id="inputQuantity" class="form-control" name="stock_quantity" value="<?php echo $products['stock_quantity'] ?>">
                </div>
                <div class="form-group">
                  ...
                  <select id="inputCategory" class="form-control custom-select" name="category_id">
                    ...
                    <?php while ($category = mysqli_fetch_assoc($query_categories)): ?>
                      <option value="<?php echo $category['category_id']; ?>"
                        <?php echo ($category['category_id'] == $products['category_id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                  ...
                  <?php if (!empty($products['image'])): ?>
                    <img src="<?php echo $products['image']; ?>" alt="Current Image" style="max-width: 200px; margin-top: 10px;">
                  <?php endif;?>
                </div>
                <div class="row">
