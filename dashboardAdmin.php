    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="page/admin/dataBarang-dashboardAdmin.php" class="nav-link">
            <i class="far fa-regular fa-user mr-2"></i>
              <p>
                Data Barang
              </p>
...
while ($users = mysqli_fetch_array($query)) {
    ...
    echo "<a class='fcc-btn1 btn btn-success' href='page/admin/edit-user-admin.php?id=" . $users['id'] . "' >Edit</a>";
    // tambahkan kode pada baris <a class='fcc-btn2' >Hapus</a>
    echo "<a class='fcc-btn2 btn btn-danger' href='page/admin/delete-user-admin.php?id=" . $users['id'] . "' >Hapus</a>";
    echo "</td>";
